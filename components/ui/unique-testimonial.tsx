...
const testimonials = [
  {
    id: 1,
    quote: 'Perfect fit, and that iridescent visor gets compliments every single ride.',
  ...
  {
    id: 2,
    quote: 'Feels premium way beyond its price — proudly Filipino and genuinely well made.',
    author: 'Maria Santos',
    role: 'Alabang, Muntinlupa',
    avatar:
      'https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=480&auto=format&fit=crop',
  },
  {
    id: 3,
    quote: 'The dual visor and vents are a game-changer in Manila traffic.',
    author: 'Carlo Reyes',
    role: 'Quezon City',
    avatar:
